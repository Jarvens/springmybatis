...
public class PBKUtils {
    ...
    public static String getEncryptedPassword(String password, String salt) throws NoSuchAlgorithmException, InvalidKeySpecException {
        KeySpec spec = new PBEKeySpec(password.toCharArray(), fromHex(salt), Constants.PBKDF2_ITERATORS,
                Constants.HASH_BIT_SIZE);
        SecretKeyFactory factory = SecretKeyFactory.getInstance(Constants.PBKDF2_ALGORITHM);
    ...
    public static String generateSalt() throws NoSuchAlgorithmException {
        ...
        byte[] salt = new byte[Constants.SALT_BYTE_SIZE];
